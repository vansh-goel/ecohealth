  ...
  return (
    <div className="home-container">
      <Helmet>
        ...
        <meta property="og:title" content="EcoHealth+" />
      </Helmet>
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <Link to="/" className="home-navlink">
          <h1 className="home-text">EcoHealth+</h1>
        </Link>
        <div data-thq="thq-navbar-nav" className="home-desktop-menu">
          <nav className="home-links">
            <Link to="/founders" className="home-navlink1">
              Founders
            </Link>
            <Link to="/map" className="home-navlink2">
              Map
            </Link>
            <Link to="/plants" className="home-navlink3">
              Plants
            </Link>
            <Link to="/events" className="home-navlink4">
              Events
            </Link>
            <Link to="/feedback" className="home-navlink5">
              Feedback
            </Link>
            <Link to="/engagement" className="home-navlink6">
              Engagement
            </Link>
            <Link to="/partners" className="home-navlink7">
              Partners
            </Link>
          </nav>
        </div>
      ...
      <div className="home-details">
        <div className="home-details1">
          <div className="home-container2">
            <h2 className="home-details-heading heading2">About EcoHealth+</h2>
      ...
      <div className="home-gallery">
        <div className="home-gallery1">
          <h1 className="home-gallery-heading heading2">Explore EcoHealth+</h1>
